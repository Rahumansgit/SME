...
export default function Ascension() {
  return (
    <div className='ascension' >
      <div className="main">
        <h1>Ascension</h1>
        <span>Ascension is the annual symposium organized by the Society of Mechanical Engineering (SME) at the College of Engineering Guindy. It serves as a platform for students and professionals to engage with the latest advancements in mechanical engineering through workshops, competitions, and guest lectures.</span>
        <div className="cards">
          <div className="card">
            <h2>Event History</h2>
